 ...
 */
public class Compat_UsStringCellDateConverter implements Compat_ColumnValueConverter<String, Date> {
    public static final String DATE_PATTERN = "MM/dd/yyyy";

    @Override
    public String serialize(Date value) {
        DateFormat df = new SimpleDateFormat(DATE_PATTERN, new Locale("us", "US"));
