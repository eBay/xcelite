...
public class BeanReaderTests  {
    ...
    void mustReadHeaderRowWithMissingCellsOK() {
        ...
        List<CamelCase> upper = getData_104( "src/test/resources/ColumnDefinitionRowHasEmptyCells.xlsx");
        validateData(upper);
    }
    ...
    public void mustThrowReadingHeaderRowWithMissingCellsOK() {
        ...
        assertThrows(java.lang.NoSuchFieldError.class, () -> {
            List<CamelCase> upper = getData_104("src/test/resources/ColumnDefinitionRowHasEmptyCells.xlsx");
            validateData(upper);
        });
    ...
    @SneakyThrows
    private List<CamelCase> getData_104(String filePath)  {
        compat.com.ebay.xcelite_104.Compat_Xcelite xcelite = new compat.com.ebay.xcelite_104.Compat_Xcelite(new File(filePath));
    ...
    private List<CamelCase> getData(XceliteOptions options, String filePath)  {
        ...
        SheetReader<CamelCase> beanReader = new BeanSheetReader<CamelCase>(sheet, options, CamelCase.class);
        ArrayList<CamelCase> data = new ArrayList<>(beanReader.read());
        return data;
    }
