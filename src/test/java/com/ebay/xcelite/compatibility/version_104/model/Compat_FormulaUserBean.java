 ...
 * @author Johannes
 */
public class Compat_FormulaUserBean implements Serializable {
    ...
    @Compat_Column(name = "BIRTHDATE", converter = Compat_UsStringCellDateConverter.class, dataFormat = Compat_UsStringCellDateConverter.DATE_PATTERN)
