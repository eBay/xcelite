 ...
 * trailing blank rows following data blocks for readers and trailing
 * null objects for writers.
 *
 * Default is SKIP.
 *
...
public enum TrailingEmptyRowPolicy {
    /**
     * SheetReaders return null for blank rows after the data block,
